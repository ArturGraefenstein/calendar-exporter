/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 600f73ac2eab62a60c3475b6bfa77fd7)
// Runtime types generated with workerd@1.20250424.0 2025-04-25 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		GOOGLE_TOKEN_JSON: string;
		SECRET_UUID: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_TOKEN_JSON" | "SECRET_UUID">> {}
}
